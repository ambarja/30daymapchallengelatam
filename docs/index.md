     ...
     <br>
        <section class="page-section" id="services">
              <div class="container">
                ...
                <h3 class="main_title">OpenSDB-PE: Open Spatial Data Base Peru</h3><br>
  <h5 class="sub_title">Open Spatial Data Base Perú, es una iniciativa cívica que pretende concienciar y difundir la cultura del gobierno abierto y las prácticas de datos abiertos</h5><br>
  <hr>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_service mt-30 wow fadeInUpBig" data-wow-duration="1.3s" data-wow-delay="0.2s">
                        ...
                        <div class="service_content">
                            <h4 class="service_title"><a href="calcolatore_campi/field_calc/" title="Il calcolatore di campi" target="_parent">Cartografía Base</a></h4>
	...
	<!-- single service -->
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_service mt-30 wow fadeInUpBig" data-wow-duration="1.3s" data-wow-delay="0.5s">
                        ...
                        <div class="service_content">
                            <h4 class="service_title"><a href="gr_funzioni/gruppo_funzioni/" title="Elenco funzioni QGIS" target="_parent">Medio Ambiente</a></h4>
	...
	<!-- single service -->
                ...
                <div class="col-lg-3 col-sm-6">
                    ...
                    <a href="corso_formazione/corso_di_formazione/" title="Corso di formazione (Novità)" target="_parent"><i class="fas fa-user-graduate fa-5x"></i></a>
                        ...
                        <div class="service_content">
                            <h4 class="service_title"><a href="corso_formazione/corso_di_formazione/" title="Corso di formazione (Novità)" target="_parent">Edafología</a></h4>
	...
	<!-- single service -->
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_service mt-30 wow fadeInUpBig" data-wow-duration="1.3s" data-wow-delay="0.2s">
                      ...
                      <div class="service_content">
                        <h4 class="service_title"><a href="contributing/" title="Supporter" target="_parent">Clima</a></h4>
